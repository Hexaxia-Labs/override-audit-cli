...
.override-hygiene{margin:0 32px 32px}
.override-hygiene h2{font-size:13px;font-weight:600;color:#e6edf3;margin-bottom:12px}
.override-hygiene p{font-size:13px;color:#8b949e}
.override-hygiene table{width:100%;border-collapse:collapse;background:#161b22;border:1px solid #30363d;border-radius:8px;overflow:hidden}
.override-hygiene table thead th{text-align:left;font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:.4px;color:#8b949e;padding:10px 14px;border-bottom:1px solid #21262d;background:#1c2128}
