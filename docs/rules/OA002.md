...
- [npm-package-json `overrides`](https://docs.npmjs.com/cli/v10/configuring-npm/package-json#overrides) — note none of these doc pages caution against floating tags
