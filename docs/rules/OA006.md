...
This was the **headline finding from dogfooding `override-audit-cli` against `hexmetrics`**. It surfaced a class of override-hygiene bugs that no other tool catches.
...
- Spec follow-up: rule introduced in v0.1.1 from dogfood-driven discovery; upgraded to multi-op `replace` in v0.2.1.
